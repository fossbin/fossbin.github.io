  ...
  return (
      <section id="hero" className="flex flex-col md:flex-row gap-10 md:gap-20 justify-center items-center mt-25 mb-10 md:mt-30">
        <div className="flex-grow basis-3/5 flex flex-col items-start md:gap-2">
          ...
          <Button variant="reverse" className="bg-blue-200 font-bold active:font-extrabold active:underline active:bg-blue-400 md:hover:font-extrabold md:hover:underline md:hover:bg-blue-400"><a href="#contact">Get in Touch!
          </a></Button>
        </div>
